...
public class TileEntityRegister {
    ...
    public static final RegistryObject<TileEntityType<TelephoneTier1TileEntity>> TELEPHONE_T1 = TILE_ENTITIES.register("telephone_t1",
            () -> TileEntityType.Builder.create(TelephoneTier1TileEntity::new, BlockRegister.TELEPHONE_T1.get()).build(null));
